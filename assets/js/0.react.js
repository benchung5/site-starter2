...
var _treeTables = __webpack_require__(959);
...
var _field_hidden = __webpack_require__(953);

var _field_hidden2 = _interopRequireDefault(_field_hidden);

var _uploaded_images = __webpack_require__(958);

var _uploaded_images2 = _interopRequireDefault(_uploaded_images);
...
var _tree_fields = __webpack_require__(960);

var _tree_fields2 = _interopRequireDefault(_tree_fields);
...
var EditTree = function (_Component) {
    ...
    _createClass(EditTree, [{
        ...
        value: function handleInitialize() {
            var images = (0, _clone2.default)(this.props.treeData.images);
        ...
        value: function handleFormSubmit(formProps) {
            ...
            this.props.updateTree((0, _form_utils.createImgFormData)('new_images', formpropsClone));
            ...
            if (this.props.treeUpdated) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        'Tree: ',
                        this.props.treeUpdated.common_name,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_tree_fields2.default, {
                                treeId: this.props.treeData.id,
                                onInputChange: this.onInputChange.bind(this),
                                treeTables: this.props.treeTables
                            }),
                            _react2.default.createElement(_uploaded_images2.default, {
                                ref: 'UploadedImages',
                            ...
                            _react2.default.createElement(_reduxForm.Field, {
                                name: 'deleted_images',
                                component: _field_hidden2.default
                            }),
                            _react2.default.createElement(_reduxForm.Field, {
                                name: 'updated_images',
                                component: _field_hidden2.default
...
function mapStateToProps(state, ownProps) {
    var selector = (0, _reduxForm.formValueSelector)('tree-add');
    return {
...
})((0, _reactRedux.connect)(mapStateToProps, { getTree: _trees.getTree, clearUpdateTree: _trees.clearUpdateTree, updateTree: _trees.updateTree, fetchTreeTables: _treeTables.fetchTreeTables })(EditTree)));
...
function renderHiddenField(field) {
	return _react2.default.createElement("input", _extends({ type: "hidden", className: "form-control" }, field.input));
}

exports.default = renderHiddenField;
...
var UPLOADS_PATH = __webpack_require__(13)[env].UPLOADS_PATH;

var UploadedImages = function (_Component) {
	_inherits(UploadedImages, _Component);

	function UploadedImages(props) {
		_classCallCheck(this, UploadedImages);

		var _this = _possibleConstructorReturn(this, (UploadedImages.__proto__ || Object.getPrototypeOf(UploadedImages)).call(this, props));
	...
	_createClass(UploadedImages, [{
		...
		value: function onDeleteClick(index) {
			...
			var updatedImages = (0, _clone2.default)(this.state.images);
			updatedImages.splice(index, 1);

			var deletedImages = (0, _clone2.default)(this.state.deletedImages);
			var imageDeleted = (0, _clone2.default)(this.state.images[index]);
		...
		value: function onCopyClick(item) {
			...
			(0, _stringUtils.copyStringToClipboard)(imgStr);
		}
	}, {
		key: 'initImages',
		...
		value: function renderImages() {
			...
			return _react2.default.createElement(
				...
				this.state.images.map(function (item, index) {
					return _react2.default.createElement(
						'div',
						{ key: index, className: 'drop-preview' },
						_react2.default.createElement('a', { href: '#', className: 'close-btn', onClick: _this3.onDeleteClick.bind(_this3, index) }),
						_react2.default.createElement(
							'button',
							{ className: 'copy-btn', onClick: _this3.onCopyClick.bind(_this3, item) },
							'copy'
						),
						_react2.default.createElement('img', { className: 'drop-img-preview', src: '/uploads/' + _this3.refType + '/' + (0, _stringUtils.imgName)(item.name, 'small') }),
						_react2.default.createElement(
							'div',
							{ className: 'desc' },
							item.name,
...
exports.default = UploadedImages;
...
exports.fetchTreeTables = fetchTreeTables;
...
function fetchTreeTables() {
	return function (dispatch) {
		_axios2.default.get(SERVER_URL + '/tree_tables/all').then(function (response) {
			dispatch({
				type: _types.FETCH_TREE_TABLES,
				payload: response.data
			});
		}).catch(function (err) {
...
var _field_dropdownSelect = __webpack_require__(961);

var _field_dropdownSelect2 = _interopRequireDefault(_field_dropdownSelect);
...
var TreeFields = function (_Component) {
  _inherits(TreeFields, _Component);

  function TreeFields(props) {
    _classCallCheck(this, TreeFields);

    return _possibleConstructorReturn(this, (TreeFields.__proto__ || Object.getPrototypeOf(TreeFields)).call(this, props));
  }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_reduxForm.Field, {
          name: 'genus_id',
          label: 'genus',
          component: _field_dropdownSelect2.default,
        ...
        _react2.default.createElement(_reduxForm.Field, {
          ...
          name: 'growth_rate',
          component: _field_dropdownSelect2.default,
          selectItems: [{ id: "slow", slug: "slow", name: "slow" }, { id: "medium", slug: "medium", name: "medium" }, { id: "fast", slug: "fast", name: "fast" }],
          onChange: this.props.onInputChange,
          onFocus: this.props.onInputChange
        }),
        _react2.default.createElement(_reduxForm.Field, {
...
var DropdownSelect = function (_Component) {
	...
	function DropdownSelect() {
		...
		return _possibleConstructorReturn(this, (DropdownSelect.__proto__ || Object.getPrototypeOf(DropdownSelect)).apply(this, arguments));
	}
	...
	_createClass(DropdownSelect, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"select",
					_extends({ className: "dropdown-select", value: input.value, onChange: this.handleChange }, input),
					this.renderSelectOptions()
				),
				_react2.default.createElement(
					"div",
