...
var EditArticle = function (_Component) {
    ...
    _createClass(EditArticle, [{
        ...
        value: function handleInitialize() {
            ...
            var images = (0, _clone2.default)(this.props.articleData.images);
        ...
        value: function handleFormSubmit(formProps) {
            ...
            this.props.updateArticle((0, _form_utils.createImgFormData)('new_images', formpropsClone));
            ...
            if (this.props.articleUpdated) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        'Article: ',
                        this.props.articleUpdated.name,
...
exports.default = (0, _require_auth2.default)((0, _reduxForm.reduxForm)({
    ...
    form: 'article-add',
    fields: ['name', 'slug']
})((0, _reactRedux.connect)(mapStateToProps, { getArticle: _articles.getArticle, clearUpdateArticle: _articles.clearUpdateArticle, updateArticle: _articles.updateArticle, fetchTags: _tags.fetchTags, fetchCategories: _categories.fetchCategories })(EditArticle)));
