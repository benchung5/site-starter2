...
var _db = __webpack_require__(965);

var actions = _interopRequireWildcard(_db);
...
var BackupDB = function (_Component) {
  _inherits(BackupDB, _Component);

  function BackupDB() {
    _classCallCheck(this, BackupDB);

    return _possibleConstructorReturn(this, (BackupDB.__proto__ || Object.getPrototypeOf(BackupDB)).apply(this, arguments));
  }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'btn', onClick: this.onBackupSubmit.bind(this) },
              'backup'
            ),
            this.renderSuccess(),
            this.renderError()
...
exports.default = (0, _require_auth2.default)((0, _reactRedux.connect)(mapStateToProps, actions)(BackupDB));
...
exports.backupDbError = backupDbError;
exports.clearBackupDb = clearBackupDb;
