...
var AddTree = function (_Component) {
  _inherits(AddTree, _Component);

  function AddTree(props) {
    _classCallCheck(this, AddTree);

    var _this = _possibleConstructorReturn(this, (AddTree.__proto__ || Object.getPrototypeOf(AddTree)).call(this, props));
      ...
      if (this.props.treeAdded && !this.props.errorMessage) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            'Tree: ',
            this.props.treeAdded.common_name,
...
})((0, _reactRedux.connect)(mapStateToProps, { addTree: _trees.addTree, clearTree: _trees.clearTree, addTreeError: _trees.addTreeError, fetchTreeTables: _treeTables.fetchTreeTables, reset: _reduxForm.reset })(AddTree)));
